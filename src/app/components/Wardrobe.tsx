import Component from "../../imports/我的衣橱-1/我的衣橱-3-630";
import svgPaths from "../../imports/我的衣橱-1/svg-qpfcijmjpa";
...
export default function Wardrobe({ onNavigate }: WardrobeProps) {
  return (
...
function BottomNav({ onNavigate }: { onNavigate: (page: Page) => void }) {
  return (
    <div className="absolute bg-[#f9fdf8] content-stretch flex gap-[77px] h-[109px] items-start left-0 pb-[43px] pt-[21px] px-[57px] rounded-[19px] top-[782px] w-[401.977px] z-50">
      <button
      ...
      >
        <p className="[word-break:break-word] absolute font-['PingFang_SC:Semibold',sans-serif] leading-[normal] left-0 not-italic text-[#709a5c] text-[12px] top-[28px] whitespace-nowrap">我的衣橱</p>
        <div className="absolute bottom-[48.89%] left-1/4 right-[27.08%] top-0">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 23 23">
            <g clipPath="url(#clip0_2_398)">
              <path d={svgPaths.p1ba08f00} fill="#709A5C" />
              <path d={svgPaths.p1a84c000} fill="#709A5C" />
            </g>
            <defs>
