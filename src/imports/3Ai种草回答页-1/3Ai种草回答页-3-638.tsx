import svgPaths from "./svg-95ckymxjgp";
import imgRectangle40 from "./564532f18be760d5266629ec45313ee4a6f15123.png";
import imgB33398F41D7E47308E7C63773C4908F21 from "./dfd0ef66740aa2144ce1f975519bce1c5961d993.png";
import imgImg34761 from "./af14a2bffeeed43494b68ab0526358d0b1cefdba.png";
import imgImg34801 from "./3da418f3dafb7f0730d48f71f929c8872b599b37.png";
import imgImg34841 from "./9fde5a2d94d09768db3e5440dbc29be178cf871b.png";
import imgImg34762 from "./6e4dbe070312abf2f88e948507bf8149d530d21f.png";
...
function Analy() {
  return (
    <div className="absolute h-[184px] left-0 right-0 top-[135px]" data-name="analy">
      ...
      <div className="[word-break:break-word] absolute font-['PingFang_SC:Regular',sans-serif] leading-[0] left-[123px] not-italic text-[#1f1f1f] text-[12px] top-[69px] whitespace-nowrap">
        <p className="leading-[24px] mb-0">低饱和奶油色系</p>
        <p>
          <span className="leading-[24px]">利用短上衣+高腰牛仔裤</span>
          <span className="[word-break:break-word] font-['PingFang_SC:Semibold',sans-serif] leading-[24px] not-italic">打造显高比例！</span>
        </p>
      </div>
    </div>
  );
...
function Group2() {
  return (
    <div className="absolute contents left-[21px] top-[46px]">
      ...
      <div className="absolute h-[130px] left-[55px] top-[76px] w-[110px]" data-name="B33398F4-1D7E-4730-8E7C-63773C4908F2 1">
      ...
      <div className="absolute h-[164px] left-[43px] top-[256px] w-[132px]" data-name="IMG_3476 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[98.08%] left-0 max-w-none top-[-0.26%] w-full" src={imgImg34761} />
        </div>
      </div>
      <div className="absolute h-[112px] left-[200px] top-[47px] w-[128px]" data-name="IMG_3480 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[114.29%] left-0 max-w-none top-[-14.29%] w-full" src={imgImg34801} />
        </div>
      </div>
      <div className="absolute h-[114px] left-[225px] top-[313px] w-[77px]" data-name="IMG_3484 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
  ...
  return (
    <div className="absolute left-[177px] size-[16px] top-[51px]">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Frame 10">
          <circle cx="8" cy="8" fill="var(--fill-0, #98BE85)" id="Ellipse 3" r="8" />
          <g id="huanyihuan 1">
            <path d={svgPaths.p24d04b80} fill="var(--fill-0, white)" id="Vector" />
          </g>
        </g>
      </svg>
    </div>
...
function Match() {
  return (
    <div className="absolute h-[523px] left-0 overflow-clip right-0 top-[334px]" data-name="match">
      ...
      <div className="absolute left-[210px] size-[111px] top-[184px]" data-name="IMG_3476 1">
...
function Remand() {
  return (
    <div className="absolute h-[118px] left-[2px] top-[-1px] w-[353px]" data-name="remand">
...
export default function Component3Ai() {
  return (
    <div className="relative size-full" style={{ backgroundImage: "linear-gradient(90deg, rgba(234, 246, 228, 0.3) 0%, rgba(234, 246, 228, 0.3) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }} data-name="3AI种草-回答页">
      <Frame6 />
